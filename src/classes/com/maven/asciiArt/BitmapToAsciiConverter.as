...
package com.maven.asciiArt
{
	...
	public class BitmapToAsciiConverter
	{
		...
		*/
		...
		public function BitmapToAsciiConverter( $whiteThreshold, $blackThreshold)
		{
			trace("BitmapToAsciiConverter constructed");

			this._whiteThreshold = $whiteThreshold;
			this._blackThreshold = $blackThreshold;
		}
		 ...
		 */
		public function parseBitmapData($data) : String
		{
			trace("parseBitmapData called");
