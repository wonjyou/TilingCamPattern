...
package com.maven
{
    ...
    public class PatternLine extends MovieClip
    {        
		...
		private var camW	:Number 	= 1200;
		private var camH	:Number 	= 1000;

		public var isLoading:Boolean = true;
		
		public var patternSize:Number = 8;	//the size of the pattern being tiled (assumes a square in dimensions)
	
		
		public function PatternLine()
        {
			trace("\nPatternLine constructed");
		...
		private function initShell() : void
		{
			...
			setTiles();
				...
				now = new BitmapData(videoMC.width, videoMC.height);
		...
		private function setColors( evt:Event = null ) : void 
		{
			...
			var ratioX:Number = videoMC.width/stage.stageWidth;
			var ratioY:Number = videoMC.height/stage.stageHeight;
			var col;
